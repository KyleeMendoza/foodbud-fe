...
function HomeFooter() {
  return (
    ...
    >
      ...
      <div className=" z-20">
        <div className="w-full flex flex-col gap-10 lg:gap-0 lg:flex-row text-center lg:text-start items-center lg:items-start py-10 lg:pt-10 flex-1  lg:justify-around px-5 lg:px-0 ">
