    ...
    <div className=" h-full">
      <div className="flex flex-col gap-10 h-full py-10 ">
        <div className="flex flex-col gap-10 items-center justify-center">
          <div className="flex flex-col w-[90%] lg:w-[70%] xl:w-[60%] 2xl:w-[55%] text-center gap-10 justify-center items-center font-['Poppins'] ">
            <p className="text-3xl font-bold capitalize text-sky-600">
              our packages
            </p>
