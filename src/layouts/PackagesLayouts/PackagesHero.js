    ...
    <div className="border-2 border-black h-full">
      <div className="flex flex-col gap-10 h-full py-10 border-2 border-green-600 ">
        <div className="flex flex-col gap-10 items-center justify-center border-2 border-red-600">
          <div className="flex flex-col w-[60%] text-center gap-10 justify-center items-center font-['Poppins'] border-2 border-blue-600">
        ...
        <div className="flex flex-1 justify-center items-center border-4 border-red-600 relative">
          <img
            src={promo}
            alt=""
            className="w-[75%] h-full absolute rounded-xl"
          />
        </div>
      </div>
    </div>
