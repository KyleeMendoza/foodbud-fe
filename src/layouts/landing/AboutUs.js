...
function AboutUs() {
  return (
    <div className="flex justify-center items-center py-20 h-full bg-red-300 relative">
      <img
        src={cw_ourStory}
        alt="Picture"
        className="h-full w-full object-cover absolute"
      />
      <div className="flex justify-center items-center  w-[60%] h-full rounded-xl text-center backdrop-blur-md bg-pink-500/30 text-white">
