...
function PackagesPage() {
  return (
    <>
      <div id="packages">
        <div className="lg:h-[160vh] xl:h-[150vh] 2xl:h-[120vh] min-[1528px]:h-[150vh] border-2 border-blue-600">
          <PackagesHero />
        </div>
        <div className="lg:h-[160vh] xl:h-[120vh] 2xl:h-[130vh] min-[1528px]:h-[150vh] border-2 border-blue-600">
          <PackagesList />
        </div>
        <div className="h-[175vh] xl:h-[150vh] 2xl:h-[120vh] min-[1528px]:h-[160vh] border-2 border-blue-600">
          <PackagesPricing />
        </div>
